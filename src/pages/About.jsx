        ...
        <div className="gird grid-cols-2">
          <div className="flex flex-col mt-10 items-center bg-neutral-950 border border-neutral-800 rounded-lg shadow lg:flex-row md:w-full  cursor-default">
            <img
              ...
              src="https://img1.wsimg.com/isteam/stock/821"
              alt="About Image"
            />
            <div className="flex flex-col justify-between px-8 leading-normal">
              ...
              <p className="mb-3 font-normal text-justify ">
                ...
                clearly there is a gap between developers and small scale
                business people. We, the{" "}
                ...
                are bringing an apportunity to explore the real world
                requiremnts to your books and creating a scope to learn with
                flexible working hours&rdquo;
              </p>
            </div>
          </div>
          <div className="flex flex-col mt-10 items-center bg-neutral-950 border border-neutral-800 rounded-lg shadow lg:flex-row md:w-full  cursor-default">
